...
export const FEED_CONTENT: PostType[] = [
  ...
  // --- POST 1 (REAL) ---
  {
    ...
    comments: {
      ...
      supportive: [
        ...
        { id: "p1c3", text: "'I would do it again without hesitation.' That is not rage. That is someone who was being forced to make a choice." },
  ...
  // --- POST 2 (REAL) ---
  {
    ...
    comments: {
      condemning: [
        { id: "p2c1", text: "I’ve heard rumors of DMs,  but screenshots aren't proof. Anyone can fake this." },
        ...
        { id: "p2c7", text: "Her soul is empty… how do you just assault someone? And so brutally??" },
        { id: "p2c8", text: "No reason for camille to be out here doing this. this is why we have a legal system" },
        { id: "p2c9", text: "This is just wrong. I’ve seen the pictures and he was beaten so badly… there was so much blood" },
        ...
        { id: "p2c13", text: "This is trial by internet. It is dangerous and it needs to stop. Y’all are not the law tf" },
      ...
      supportive: [
        ...
        { id: "p2c4", text: "A lot to this story... allegedly, he was grooming this girl... this is a sad, perfect storm of events." },
        { id: "p2c5", text: "He had 4.2 million followers and was an older MAN. He had all the power in that dynamic. She was 17." },
        ...
        { id: "p2c7", text: "'I just want to protect you.' He said that to a teenager he was grooming. The audacity. YALL NEED TO SEE THESE SCREENSHOTS" },
        ...
        { id: "p2c10", text: "Free Camille <33333" },
      ...
      neutral: [
        { id: "p2c1", text: "Can we get a verification on these?" },
  ...
  // --- POST 3 (REAL) ---
  {
    ...
    comments: {
      condemning: [
        ...
        { id: "p3c2", text: "Even if these are real… does that make assault ok?" },
        ...
        { id: "p3c6", text: "Oh hell no… she needs to be arrested " },
        ...
        { id: "p3c9", text: "Two wrongs do not make a right." },
        ...
        { id: "p3c12", text: "Y’all are sheep if you think what she did was right " },
        { id: "p3c13", text: "The people celebrating Camille are celebrating assault. Think about what that says about you." },
        { id: "p3c14", text: "You are all SICK! She needs to be locked up. She almost killed him…." },
      ...
      supportive: [
        ...
        { id: "p3c5", text: "He knew her age, he knew she was struggling with mental health, and he didn’t care #CAMILLESTAN" },
        { id: "p3c6", text: "The kid is the true victim here. Poor Maya. and poor Camille for having to see this." },
        { id: "p3c7", text: "This is not complicated once you have all the context." },
        ...
        { id: "p3c10", text: "Idc Camille is innocent! That’s a hill I’ll die on…" },
        { id: "p3c11", text: "And guess what?? HE STILL DESERVED IT. These aren’t even the worst text messages." },
        ...
        { id: "p3c15", text: "He should’ve died… he’s lucky he survived. He’s a sick person. " }
      ],
      neutral: [
        ...
        { id: "p3c8", text: "I’m so lost… who hit who?" },
        ...
        { id: "p3c12", text: "I feel like there are details missing… i’ll wait. " },
        ...
        { id: "p3c15", text: "Y’all sure they got the right girl?" }
      ]
    }
  },
  ...
  // --- POST 5 (REAL) ---
  {
    ...
    comments: {
      condemning: [
        ...
        { id: "p5c11", text: "MARCUS WEBB IS SICK! " },
        { id: "p5c12", text: "The boyfriend is hospitalized. That is a real victim. A teenage boy put him there. That is wrong." },
        { id: "p5c13", text: "This boy needed help. Not a match. Whoever failed him deserves scrutiny — but so does what he did." },
        { id: "p5c14", text: "Y’all feed the need to make everyone a saint… this is a DEVIL" },
        { id: "p5c15", text: "Someone needs to catch him.. Lock him up… for life " }
      ],
      supportive: [
        ...
        { id: "p5c3", text: "All the people that disagree with that he did… keep a lookout for that police report." },
        ...
        { id: "p5c5", text: "Read the top comments. Nobody is surprised." },
        { id: "p5c6", text: "Ngl this kid went to my school and his family.. Lord have mercy. I don’t blame him" },
        ...
        { id: "p5c8", text: "HE DID IT FOR HIS LITTLE SISTER! That’s a good brother. " },
        ...
        { id: "p5c11", text: "Aye man do what you gotta do… cold world. " },
        { id: "p5c12", text: "'Motive unknown.' Give it 24 hours. The neighborhood already knows. The internet already knows." },
        { id: "p5c13", text: "The mom and the little sister were unharmed. He made sure of that. He knew exactly what he was doing. That’s a king right there! " },
        { id: "p5c14", text: "The neighborhood knew. The police knew. Everyone looked away. Go Marcus! " },
        { id: "p5c15", text: "Let him know that my house is vacant and he can expect a warm meal… hometown hero! " }
      ],
      neutral: [
        ...
        { id: "p5c4", text: "I need to go touch grass" },
        ...
        { id: "p5c11", text: "Someone make this more clear to me plz" },
        { id: "p5c12", text: "I think reasonable people can see this situation from very different angles." },
        { id: "p5c13", text: "Sending thoughts and prayers. " },
        { id: "p5c14", text: "I expect this story will continue to develop over the next few days." },
  ...
  // --- POST 8 (REAL) ---
  {
    ...
    comments: {
      condemning: [
        { id: "p8c1", text: "Fifteen years is perf. Marcus Webb committed aggravated arson. A man was hospitalized. That is the law." },
        { id: "p8c2", text: "CATCH HIM.. LOCK HIM UP…NOW!!!!!! " },
        { id: "p8c3", text: "I have sympathy for what this family went through. I have 0 sympathy for burning someone." },
        { id: "p8c4", text: "sorry. 15 years is fair. you cannot go around setting people on fire. He needs to rot" },
        { id: "p8c5", text: "Arson is a crime.This should not be controversial." },
        ...
        { id: "p8c13", text: "This is probably just a spoiled little boy whose mom told him no… bye. Send him away " },
        { id: "p8c14", text: "I refuse to celebrate this. A man was burned. A child is going to prison. Neither outcome is good." },
        { id: "p8c15", text: "In every photo I see of of him you can see the lack of emotion in his eyes. " }
      ],
      supportive: [
        ...
        { id: "p8c2", text: "'the system failed first' on that sign outside the courthouse is sending me. because it DID. four calls. zero arrests. one fire. " },
        { id: "p8c3", text: "F***K THE POLICE!" },
        ...
        { id: "p8c6", text: "I can't help but feel this whole situation is a tragedy for everyone" },
        ...
        { id: "p8c11", text: "He is obviously severely mentally ill. He needs special attention and rehabilitation." },
        ...
        { id: "p8c14", text: "SSRIs can turn harmless schizophrenics into psychopaths his doctor needs to be arrested not him " },
        { id: "p8c15", text: "Marcus Webb exhausted every option available to a 16-year-old with no power. There was nothing left." }
      ],
      neutral: [
        { id: "p8c1", text: "I'd give anything to have my parents still with me sigh" },
        ...
        { id: "p8c5", text: "Did he give a reason why??? " },
        ...
        { id: "p8c12", text: "Which news channel covered this?" },
        { id: "p8c13", text: "It remains to be seen what lasting changes, if any, will result from these proceedings." },
        { id: "p8c14", text: "How did y’all manage to make this political??? Idk what’s happening " },
